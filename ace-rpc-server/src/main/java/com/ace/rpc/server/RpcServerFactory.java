...
import com.ace.rpc.core.RpcService;
...
public class RpcServerFactory {
    ...
    @Value("${ismp.rpc.registry.server.host:localhost}")
            ...
            try {
                ...
                if (serviceSet != null && !serviceSet.isEmpty()) {
                    for (Object classObject : serviceSet) {
                        ...
                        String classPath = classObject.toString();
                        classPath = classPath.split(" ")[1];
                        Object serviceImpl = serviceBeanFactory.createBean(Class.forName(classPath));
